...
HINTS = {
    ...
    "relocate_enabled": "开启后，超时未完成的订阅种子不再直接删除，改为移入收容目录保留做种",
    "relocate_dir": "收容种子移动到这里，该目录不参与媒体库整理",
    "relocate_after_hours": "下载超过该时长仍未完成即转入收容目录，默认6小时",
    "relocate_delete_files": "关闭则到期仅删除下载任务、保留已下载文件",
    "default_hr_hours": "站点未单独配置时使用的H&R时长，默认168小时",
    "site_hr_hours": "格式：站点名:小时，多个用逗号或换行分隔，例如 CARPT:168,听听歌:72",
